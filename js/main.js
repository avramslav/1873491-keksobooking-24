...
console.log(getRandomArbitrary(-1.3, 1.4, 3));
...
let temporaryData = {
  author: {
    avatar: 'img/avatars/user01.png',/* строка — адрес изображения вида img/avatars/user{{xx}}.png, где {{xx}} — это число от 1 до 10.
